  ...
  if (user.type == "recruiter") {
    Recruiter.findOne({ userId: user._id })
      .then((recruiter) => {
        ...
        if (data.surname) {
          recruiter.surname = data.surname;
        }
        ...
        if (data.experience) {
          recruiter.experience = data.experience;
        }
        if (data.socialMediaLinks) {
          recruiter.socialMediaLinks = data.socialMediaLinks;
        }
    ...
    if (status === "accepted") {
      ...
      Application.findOneAndUpdate(
        ...
        .then((application) => {
          ...
          if (status === "finished") {
            console.log(status, "status124144x");
            res.json({
